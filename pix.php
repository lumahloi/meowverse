...
$sqlp .= "status_ped = 'Aguardando pagamento do pix', ";
...
<head>
    ...
    <style>
        ...
        /* Classe para esconder a div flutuante por padrão */
        .escondida {
            display: none;
        }
    </style>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mb-0">
                        ...
                        <span class="mx-2 mb-0">/</span>
                        <strong class="text-black">PIX</strong>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="site-section">
            <div class="container">
                ...
                <p>Obrigado por comprar em nossa loja. Seu pedido foi aceito e está aguardando pagamento. Por favor,
                    clique no botão abaixo, realize o PIX e pagando em qualquer banco.</p>
                ...
                <div class="p-3 p-lg-5 border">
                    ...
                    <div class="row row-cols-2 p-3">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <p><span style="font-weight:bold;">Forma de pagamento</span>: PIX</p>
                            <p><span style="font-weight:bold;">Status</span>: Aguardando pagamento do PIX</p>
                        </div>
                    ...
                    <div class="row justify-content-md-end mt-5">
                        ...
                        <div class="col-md-3">
                            <button class="btn btn-outline-primary btn-block py-3" id="abrir">Gerar QR Code</button>
                        </div>

                    </div>
                </div>
                
                <div id="divFlutuante" class="escondida">
                    <div class="row justify-content-end"><div class="col"><span class="icon icon-close" id="fechar"></div></span></div>
                    <div class="row justify-content-center"><div class="col-6"><img src="imagens/qr_code.png" alt="QR Code" class="img-fluid"></div></div>
                    <p class="text-center">3ea77c7a-f0f9-4d2d-a859-0b259bf6a2c2</p>
                    <div class="row justify-content-center"><div class="col-6 text-center"><button class="btn btn-primary py-3 mt-3" id="copiar">Copiar chave</button></div></div>
                </div>
