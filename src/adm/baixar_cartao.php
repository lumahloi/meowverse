      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Contas a Receber /</span> Confirmar liberação do cartão</h4>
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?PHP print substr($data,8,2) . "/" . substr($data,5,2) . "/" . substr($data,0,4); ?>
                        </td>
                    ...
                    <!-- Exibe botão baixar para baixar o pag -->
                        <td>
                            <div class="col-md-12">
                                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                <li class="nav-item">
                                    <a class="nav-link active" href="baixar_cartao1.php?acao=alt&id=<?PHP print $id; ?>&titulo=Liberação de cartão de crédito"></i>Baixar pagamento</a>
                                </li>
                                </ul>
                            </div>
                        </td>
