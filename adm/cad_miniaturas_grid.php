      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manutenção Cadastral /</span> Produtos</h4>

            <div class="row">
              <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                  <li class="nav-item">
                    <a class="nav-link active" href="cad_miniaturas.php?acao=ins&amp;titulo=Inclusão de registro"><i
                        class="bx bx-shopping-bag me-1"></i> Inserir novo produto</a>
                  </li>
                </ul>
              </div>
            </div>
                          ...
                          <div class="col-xl-6 mb-xl-0 mb-3">
                            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                              <div class="btn-group" role="group" aria-label="First group">
                                  <a class="dropdown-item" href="cad_miniaturas.php?acao=alt&id=<?PHP print $id; ?>&titulo=Alteração de registro"><i class="bx bx-edit-alt me-1"></i></a>
                                  <a class="dropdown-item" href="cad_miniaturas.php?acao=ver&id=<?PHP print $id; ?>&titulo=Detalhes da miniatura"><i class="bx bx-search me-1"></i></a>
                                  <a class="dropdown-item" href="cad_miniaturas.php?acao=exc&id=<?PHP print $id; ?>&titulo=Exclusão de registro"><i class="bx bx-trash me-1"></i></a>
                              </div>
                            </div>
                          </div>
                        </td>
